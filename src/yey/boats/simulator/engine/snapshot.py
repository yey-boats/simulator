...
class TelemetrySnapshot:
    ...
    # cumulative engine-on seconds (HourMeter; -> propulsion.main.runTime)
    ...
    # electrical.batteries.starter.stateOfCharge (ratio)
    ...
    # (lat,lon) jitter applied to published position
